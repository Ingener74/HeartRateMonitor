...
if(NOT OpenCV_ROOT)
  ...
  if(OpenCV_INCLUDE_DIR)
    # Mac OS Framework
    string(REGEX REPLACE "/Headers(/.*)?$" "" OpenCV_ROOT "${OpenCV_INCLUDE_DIR}")
    # OpenCV 1
    string(REGEX REPLACE "/include(/.*)$" "" OpenCV_ROOT "${OpenCV_ROOT}")
    # OpenCV >= 2
    if(EXISTS "${OpenCV_ROOT}/share/opencv/OpenCVConfig.cmake")
      set(OpenCV_ROOT "${OpenCV_ROOT}/share/opencv")
    endif()
    # cache it such that users can view/correct it
    set(OpenCV_ROOT "${OpenCV_ROOT}" CACHE PATH "Installation prefix of OpenCV Library." FORCE)
  endif()
endif()
...
if(EXISTS "${OpenCV_ROOT}")
  ...
  # --------------------------------------------------------------------------
  # OpenCV 2
  if(EXISTS "${OpenCV_ROOT}/OpenCVConfig.cmake")

    include("${OpenCV_ROOT}/OpenCVConfig.cmake")
